...
interface MarketInsightFiltersProps {
  onFiltersChange: (filters: { assetClasses: string[]; strategies: string[] }) => void
  initialFilters?: { assetClasses: string[]; strategies: string[] }
}

export function MarketInsightFilters({
  onFiltersChange,
  initialFilters = { assetClasses: [], strategies: [] },
}: MarketInsightFiltersProps) {
  ...
  useEffect(() => {
    setSelectedAssetClasses(initialFilters.assetClasses || [])
    setSelectedStrategies(initialFilters.strategies || [])
  }, [initialFilters])
