        ...
        <div className="w-full max-w-md">
          ...
          <Card className="border-0 shadow-lg">
            <CardHeader className="text-center pb-4">
              <CardTitle className="text-2xl font-bold text-[#00B2FF]">Vestira for Managers</CardTitle>
              <CardDescription>Sign in to access your manager dashboard</CardDescription>
            </CardHeader>
              ...
              <TabsContent value="signup" className="mt-0">
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="firmName" placeholder="Your Asset Management Firm" />
                  </div>
