    ...
    <div className="container mx-auto px-6 py-8 md:px-8 lg:px-10 max-w-7xl">
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-base text-base-gray">Welcome back to your manager dashboard.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-vestira p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/screens/manager/allocator-search">
              <div className="group flex items-center gap-3 p-4 rounded-lg bg-electric-blue/5 hover:bg-electric-blue/10 border border-electric-blue/20 hover:border-electric-blue/30 transition-all duration-300 min-h-[80px]">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-medium text-deep-brand text-sm">Find Allocators</h3>
                  <p className="text-xs text-base-gray">Search allocators</p>
                </div>
            ...
            <Link href="/screens/manager/due-diligence-hub">
              <div className="group flex items-center gap-3 p-4 rounded-lg bg-electric-blue/5 hover:bg-electric-blue/10 border border-electric-blue/20 hover:border-electric-blue/30 transition-all duration-300 min-h-[80px]">
                <div className="p-2 rounded-full bg-white shadow-sm">
            ...
            <Link href="/screens/manager/data-rooms">
              <div className="group flex items-center gap-3 p-4 rounded-lg bg-electric-blue/5 hover:bg-electric-blue/10 border border-electric-blue/20 hover:border-electric-blue/30 transition-all duration-300 min-h-[80px]">
                <div className="p-2 rounded-full bg-white shadow-sm">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Link href="/screens/manager/clients">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-deep-brand">18</p>
                  </div>
          ...
          <Link href="/screens/manager/due-diligence-hub?tab=active">
            <Card className="vestira-card-minimal hover:shadow-vestira-lg transition-all duration-300 cursor-pointer border-2 hover:border-electric-blue/20">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-deep-brand">5</p>
                  </div>
                  <div className="p-3 bg-electric-blue/10 rounded-full">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-base-gray">Your recent interactions with clients</CardDescription>
                </div>
                <Link href="/screens/manager/activity-log">
          ...
          <Card className="col-span-3 vestira-card-minimal">
            ...
            <CardContent>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <Link href="/screens/manager/events">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="text-base-gray">
                  Recent insights from your portfolio companies
                </CardDescription>
              </div>
              <Link href="/screens/manager/market-insights?tab=performance">
                <Button variant="outline" size="sm">
                  View All Insights
                </Button>
              </Link>
