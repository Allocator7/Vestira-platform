...
// Manager-specific insights data
const allInsights = [
  {
    id: "1",
    title: "Fundraising Market Trends",
    description: "Analysis of current fundraising environment and investor appetite across asset classes",
    date: "June 2, 2025",
    dateObj: new Date("2025-06-02"),
    category: "market-analysis",
    categoryDisplay: "Market Analysis",
    image: "/sustainable-investing.png",
    icon: BookOpen,
    tab: "my-client-insights",
    content: "Detailed analysis of fundraising trends and market conditions...",
    ...
    shares: 62,
    bookmarks: 89,
    tags: ["Fundraising", "Market Trends", "LP Appetite"],
  },
  {
    id: "2",
    title: "LP Allocation Strategies",
    description: "Understanding institutional investor allocation preferences and decision-making processes",
    date: "May 28, 2025",
    ...
    icon: TrendingUp,
    tab: "all-insights",
    content: "Comprehensive guide to LP allocation strategies...",
    ...
    shares: 45,
    bookmarks: 67,
    tags: ["LP Strategy", "Allocation", "Institutional"],
  },
  {
    id: "3",
    title: "Due Diligence Best Practices",
    description: "Key insights from successful due diligence processes and investor expectations",
    date: "May 25, 2025",
    ...
    icon: TrendingUp,
    tab: "all-insights",
    content: "Best practices for due diligence processes...",
    ...
    shares: 34,
    bookmarks: 52,
    tags: ["Due Diligence", "Best Practices", "Investor Relations"],
  },
  {
    id: "4",
    title: "ESG Integration in Investment Process",
    description: "How to effectively integrate ESG considerations into your investment strategy",
    date: "May 20, 2025",
    ...
    icon: TrendingUp,
    tab: "all-insights",
    content: "ESG integration strategies and implementation...",
    author: "ESG Team",
    readTime: "7 min read",
    readTimeMinutes: 7,
    likes: 142,
    shares: 58,
    bookmarks: 76,
    tags: ["ESG", "Sustainability", "Investment Process"],
  },
  {
    id: "5",
    title: "Alternative Investment Opportunities",
    description: "Emerging sectors and strategies in alternative investments for 2025",
    date: "June 1, 2025",
    ...
    author: "Alternatives Team",
    readTime: "9 min read",
    readTimeMinutes: 9,
    likes: 187,
    shares: 73,
    bookmarks: 94,
    tags: ["Alternatives", "Emerging Markets", "Innovation"],
  },
  {
    id: "6",
    title: "Digital Assets and Crypto Integration",
    description: "Institutional adoption of digital assets and cryptocurrency strategies",
    date: "May 27, 2025",
    ...
    icon: TrendingUp,
    tab: "investment-trends",
    content: "Digital assets integration for institutional portfolios...",
    ...
    shares: 78,
    bookmarks: 95,
    tags: ["Digital Assets", "Cryptocurrency", "Innovation"],
  },
  {
    id: "7",
    title: "Client Relationship Management",
    description: "Best practices for building and maintaining strong investor relationships",
    date: "June 5, 2025",
    dateObj: new Date("2025-06-05"),
    category: "client-relations",
    categoryDisplay: "Client Relations",
    image: "/portfolio-diversification.png",
    icon: Users,
    tab: "my-client-insights",
    content: "Strategies for effective client relationship management...",
    ...
    shares: 56,
    bookmarks: 78,
    tags: ["Client Relations", "Communication", "Investor Relations"],
  },
  {
    id: "8",
    title: "Performance Reporting Standards",
    description: "Industry standards and best practices for performance reporting to investors",
    date: "May 30, 2025",
    dateObj: new Date("2025-05-30"),
    category: "reporting",
    categoryDisplay: "Reporting",
    image: "/pension-fund-allocation.png",
    icon: Users,
    tab: "my-client-insights",
    content: "Performance reporting standards and investor expectations...",
    ...
    shares: 38,
    bookmarks: 62,
    tags: ["Performance", "Reporting", "Standards"],
  },
  {
    id: "9",
    title: "Infrastructure Investment Trends",
    description: "Latest developments in infrastructure investing and institutional demand",
    date: "June 3, 2025",
    ...
    icon: TrendingUp,
    tab: "investment-trends",
    content: "Infrastructure investment trends and opportunities...",
    ...
    shares: 67,
    bookmarks: 83,
    tags: ["Infrastructure", "Real Assets", "Institutional Demand"],
  },
]
...
const FILTER_SECTIONS = {
  ...
  author: {
    ...
    icon: User,
    options: [
      { value: "market-research-team", label: "Market Research Team" },
      { value: "strategy-team", label: "Strategy Team" },
      { value: "due-diligence-team", label: "Due Diligence Team" },
      { value: "esg-team", label: "ESG Team" },
      { value: "alternatives-team", label: "Alternatives Team" },
      { value: "digital-assets-team", label: "Digital Assets Team" },
      { value: "client-relations-team", label: "Client Relations Team" },
