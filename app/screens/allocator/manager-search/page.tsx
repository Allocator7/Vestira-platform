...
const managers = [
  {
    id: 1,
    firmName: "Growth Capital Partners",
    ...
    isBookmarked: true,
    contacts: [
      { name: "David Rodriguez", title: "Managing Partner", strategy: "Growth Equity", email: "david.rodriguez@growthcapital.com" },
      { name: "Sarah Johnson", title: "Senior Vice President", strategy: "Buyouts", email: "sarah.johnson@growthcapital.com" },
    ],
  },
  {
    id: 2,
    firmName: "Sustainable Equity Fund",
    name: "Sarah Chen",
    ...
    isBookmarked: false,
    contacts: [
      { name: "Sarah Chen", title: "Portfolio Manager", strategy: "ESG/Sustainable Equity", email: "sarah@sustainableequity.com" },
      { name: "Lisa Thompson", title: "ESG Director", strategy: "Long/Short Equity", email: "lisa.thompson@sustainableequity.com" },
    ],
  },
  {
    id: 3,
    firmName: "Infrastructure Capital",
    ...
    contacts: [
      ...
      { name: "Emma Wilson", title: "Head of Infrastructure", strategy: "Real Estate Debt", email: "emma.wilson@infrastructurecapital.com" },
    ],
  },
]
